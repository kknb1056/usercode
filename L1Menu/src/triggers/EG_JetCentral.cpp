...
namespace l1menu
{
	namespace triggers
	{
		 ...
		 */
		REGISTER_TRIGGER_AND_CUSTOMISE( EG_JetCentral_v0,
			[]() // Use a lambda function to customise rather than creating a named function that never gets used again.
			{
				l1menu::TriggerTable& triggerTable=l1menu::TriggerTable::instance();
				EG_JetCentral_v0 tempTriggerInstance;
...
bool l1menu::triggers::EG_JetCentral_v0::apply( const l1menu::IEvent& event ) const
{
...
void l1menu::triggers::EG_JetCentral::initiateForReducedSample( const l1menu::ReducedMenuSample& sample )
{
	...
	if( iFindResult==parameterIdentifiers.end() ) throw std::runtime_error( "EG_JetCentral::initiateForReducedSample() - it appears this reduced sample wasn't created with this trigger. You can only run over a l1menu::ReducedMenuSample with triggers that were on when the sample was created." );
...
bool l1menu::triggers::EG_JetCentral::apply( const l1menu::IReducedEvent& event ) const
{
