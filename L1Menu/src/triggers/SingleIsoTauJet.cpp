...
void l1menu::triggers::SingleIsoTauJet::initiateForReducedSample( const l1menu::ReducedMenuSample& sample )
{
...
bool l1menu::triggers::SingleIsoTauJet::apply( const l1menu::ReducedEvent& event ) const
{
