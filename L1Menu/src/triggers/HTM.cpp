	...
	namespace triggers
	{
		...
		REGISTER_TRIGGER_AND_CUSTOMISE( HTM_v0,
			[]() // Use a lambda function to customise rather than creating a named function that never gets used again.
			{
				...
				triggerTable.registerSuggestedBinning( tempTriggerInstance.name(), "threshold1", 100, 0, 300 );
...
bool l1menu::triggers::HTM_v0::apply( const l1menu::IEvent& event ) const
{
...
bool l1menu::triggers::HTM::apply( const l1menu::IReducedEvent& event ) const
{
