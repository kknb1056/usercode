	...
	namespace triggers
	{
		...
		REGISTER_TRIGGER_AND_CUSTOMISE( DoubleJetCentral_v0,
			[]() // Use a lambda function to customise rather than creating a named function that never gets used again.
			{
				...
				triggerTable.registerSuggestedBinning( tempTriggerInstance.name(), "threshold2", 100, 0, 120 );
...
bool l1menu::triggers::DoubleJetCentral::apply( const l1menu::ReducedEvent& event ) const
{
