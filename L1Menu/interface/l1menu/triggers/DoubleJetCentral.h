#ifndef menugeneration_triggers_DoubleJetCentral_h
#define menugeneration_triggers_DoubleJetCentral_h
...
namespace menugeneration
{
	namespace triggers
	{
		 ...
		 * @date 29/Apr/2013
		 */
		class DoubleJetCentral : public menugeneration::ITrigger
		{
		public:
			DoubleJetCentral();
