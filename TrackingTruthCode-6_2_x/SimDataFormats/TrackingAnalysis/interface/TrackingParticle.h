...
public:
   ...
   /** Gives the same result as the old trackPSimHit().size(). I think that's the
    * same as matchedHits, but I'm not certain. If I do find out they're equivalent
    * I'll take this method out.
    */
   int numberOfHits() const;

   /// Gives the same result as the old trackPSimHit(DetId::Tracker).size()
